...
@Log4j2
@Repository
public class ConversionAlnovaSpeiEnvios {
	...
	public Mono<String> SepCadenaSpeEnv(String cadenahomologar) throws ParseException {
		cont++;
		...
		String FECHAOPERACION = ncadena[3]; // Cabecero
		//[0] FCNOM_ORD
		//[1] FIFOLIO
		//[2] FITIPOPAGO
		//[3]
		...
		String ncadenaNu = cadenahomologar.replaceAll("\\{", "").replaceAll("}", ",").replaceAll("-", "").replaceAll("&", "").replaceAll("20221209 00:00:00.0", "20220912").trim();
